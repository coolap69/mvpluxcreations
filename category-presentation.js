(function installCategoryPresentation(root) {
  ...
  function resolveCategoryPresentation(category = {}, options = {}) {
    ...
    const resolvedDisplay = {
      ...
      standeeRotationDeg: clampNumber(display.standeeRotationDeg, 0, -180, 180),
  ...
  function resolveCategoryCardLayout(presentation = {}) {
    ...
    return {
      ...
      imageRotationDeg: clampNumber(display.standeeRotationDeg, 0, -180, 180),
      imageTransform: `translateX(-50%) rotate(${clampNumber(display.standeeRotationDeg, 0, -180, 180)}deg)`,
      backgroundPosition: String(display.backgroundPosition || 'center bottom'),
