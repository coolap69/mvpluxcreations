...
Deno.test('sign-in requests the homepage Admin cache version while sign-up keeps immediate binding', async () => {
  ...
  assert(signin.includes('category-presentation.js?v=20260823-category-sync') && signin.includes('script.js?v=20260823-category-sync'), 'signin.html must load the synchronized storefront architecture without stale cache');
  assert(signup.includes('category-presentation.js?v=20260823-category-sync') && signup.includes('script.js?v=20260823-category-sync'), 'signup.html must retain the synchronized storefront architecture');
});
